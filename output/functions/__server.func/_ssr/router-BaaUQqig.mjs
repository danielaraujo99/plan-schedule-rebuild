...
var Route$2 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{ title: "Maison Élan Beauty — Agendamento" },
			{
				name: "description",
				content: "Agende sua experiência de beleza no Maison Élan Beauty."
			},
			{
				name: "author",
				content: "Maison Élan Beauty"
			},
			{
				property: "og:title",
				content: "Maison Élan Beauty — Agendamento"
			},
			{
			...
			{
				property: "og:image",
				content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/db718c85-dc47-46fe-a257-16bc1689a2ad"
			},
			{
				name: "twitter:image",
				content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/db718c85-dc47-46fe-a257-16bc1689a2ad"
...
var Route$1 = createFileRoute("/agendamento")({
	head: () => ({ meta: [{ title: "Agendamento — Maison Élan Beauty" }, {
		name: "description",
		content: "Reserve seu horário em poucos passos."
	}] }),
...
var Route = createFileRoute("/")({
	head: () => ({ meta: [
		...
		{
			name: "description",
			content: "Estúdio de manicure, alongamento em gel e spa dos pés em Cachoeiro. Agende seu horário pelo WhatsApp."
		},
		{
			property: "og:title",
			content: "Maison Élan Beauty"
		...
		{
			property: "og:description",
			content: "Agende sua experiência de beleza."
		}
	] }),
	component: lazyRouteComponent($$splitComponentImporter, "component")
});
var AgendamentoRoute = Route$1.update({
	id: "/agendamento",
	path: "/agendamento",
