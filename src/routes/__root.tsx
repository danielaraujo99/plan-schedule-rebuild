...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Agende sua experiência de beleza no Maison Élan Beauty." },
      { name: "author", content: "Maison Élan Beauty" },
      { property: "og:title", content: "Maison Élan Beauty — Agendamento" },
      { property: "og:description", content: "Agende sua experiência de beleza no Maison Élan Beauty." },
